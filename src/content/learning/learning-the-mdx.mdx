...
pubDate: 2025-11-28 # 文章首次发布日期
updatedDate: 2025-11-29 # 如果文章有更新，建议加上这个字段
author: CNDLive Academy
cover: './covers/ndx-cover.webp' # 封面图路径（假设您有一张封面图）
...
（1）[MDX 官方文档](https://www.mdxjs.cn/docs/)

## markdown入门教程

【1】[Markdown 极速入门：10 分钟搞定文档写作](learning-the-markdown)

<AnimatedEmojiContainer emoji="🏆" size="text-6xl" className="my-8 block text-center" />

<FooterNavigationLinks className="mt-12" />