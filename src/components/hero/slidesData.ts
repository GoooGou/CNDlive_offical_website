...
export const slidesData: HeroData[] = [
  ...
  },
  {
    ...
    description:
      'Experience zero latency and high fidelity audio support with our latest hardware solutions.',
  ...
  },
  {
    ...
    description:
      'Portable, powerful, and plug-and-play. Take your live stream to the outdoors.',
